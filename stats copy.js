async function traerDatos() {
    try {
        ...
        const datosWeb = await response.json()                                           // guardo esa respuesta 'response' en formato JSON (texto)
        console.log('datos WEB:', datosWeb)
        let eventsWeb = datosWeb.events                                                  // guardo los datos correspondientes a la clave 'results'
        console.log("eventos WEB:", eventsWeb)
        return eventsWeb
    } catch (error) {
